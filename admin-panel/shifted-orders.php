...
WHERE order_items.status != 'pending' AND order_items.status = 'shifted'
";
...
<div id="right-panel" class="right-panel">
    ...
    <div class="">
        <div class="col-12 mt-4">
            <h1 class=" mb-5 mt-3 text-primary text-center" style="text-decoration: underline; font-size: 40px;">Shifted
                Orders
            </h1>
