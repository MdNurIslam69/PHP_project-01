<title><?php echo isset($title) ? $title : "Cancel Orders | Imran_Store"; ?></title>
...
if (isset($_POST['updateStatus'])) {
    ...
    $status = $_POST['status'];
    $updateQuery = "UPDATE `orders` SET `status` = '$status' WHERE `id` = '$order_item_id'";
...
<div id="right-panel" class="right-panel">
    ...
    <div class="">
        <div class="col-12 mt-4">
            <h1 class=" mb-5 mt-3 text-primary text-center" style="text-decoration: underline; font-size: 40px;">Cancel
                Orders
            </h1>
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td class="text-center align-middle p-0" style="border: 1px solid black"><img
                                        ...
                                        width="80" height="80" class=" object-fit-contain"></td>
                            ...
                            <br><br><br><br>
                            <p class="text-center text-danger" style="font-size: 30px;">No Cancel orders
                                found</p>
