<title><?php echo isset($title) ? $title : "Refunded Orders | Imran_Store"; ?></title>
...
if (isset($_POST['updateStatus'])) {
    $order_id = $_POST['order_id']; //  use order_id
    $status = $_POST['status'];

    //  update the orders table instead of order_items
...
//  FIXED QUERY: Use orders.status instead of order_items.status
$query = "
SELECT 
        ...
        <div class="col-12 mt-4">
            ...
            <div>
                <div class="">
                    ...
                    <br><br><br><br>
                    <p class="text-center text-danger" style="font-size: 30px;">No Refunded orders
                        found</p>
